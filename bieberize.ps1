 <# 
    Powershell Script to bring the user back to the early 2000s with some classic Bieber. 
    Uses Jose Espita's Set-Wallpaper Function (https://www.joseespitia.com/2017/09/15/set-wallpaper-powershell-function/)
#>
